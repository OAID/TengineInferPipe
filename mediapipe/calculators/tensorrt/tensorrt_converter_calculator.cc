...
#include "mediapipe/calculators/tensorrt/tensorrt_converter_calculator.pb.h"
...
class TensorrtConverterCalculator : public CalculatorBase {
 public:
...
REGISTER_CALCULATOR(TensorrtConverterCalculator);
...
absl::Status TensorrtConverterCalculator::GetContract(CalculatorContract* cc) {
...
absl::Status TensorrtConverterCalculator::Open(CalculatorContext* cc) {
...
absl::Status TensorrtConverterCalculator::Process(CalculatorContext* cc) {
...
absl::Status TensorrtConverterCalculator::Close(CalculatorContext* cc) {
  return absl::OkStatus();
}

absl::Status TensorrtConverterCalculator::ProcessCPU(CalculatorContext* cc) {
  if (cc->Inputs().HasTag(kImageFrameTag)) {
...
absl::Status TensorrtConverterCalculator::ProcessGPU(CalculatorContext* cc) {
  return absl::OkStatus();
}

absl::Status TensorrtConverterCalculator::InitGpu(CalculatorContext* cc) {

  return absl::OkStatus();
}

absl::Status TensorrtConverterCalculator::LoadOptions(CalculatorContext* cc) {
  // Get calculator options specified in the graph.
  const auto& options =
      cc->Options<::mediapipe::TensorrtConverterCalculatorOptions>();
...
template <class T>
absl::Status TensorrtConverterCalculator::NormalizeImage(
...
absl::Status TensorrtConverterCalculator::CopyMatrixToTensor(const Matrix& matrix,
                                                           float* tensor_ptr) {
